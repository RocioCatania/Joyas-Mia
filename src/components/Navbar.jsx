...
return (
    <nav className=' w-100 d-flex justify-content-between align-items-center'>
        ...
        <ul className=' w-50 list-unstyled text-decoration-none d-flex flex-row justify-content-center '>
            <li><Link className= "btn btn-outline-warning mx-4 " to="/aros">Aros</Link></li>
            <li><Link className= "btn btn-outline-warning mx-4 " to="/collares">Collares</Link></li>
            <li><Link className= "btn btn-outline-warning mx-4 " to="/anillos">Anillos</Link></li>
